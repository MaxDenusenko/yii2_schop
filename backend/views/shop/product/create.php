...
<div class="product-create">
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4">
                    <?= $form->field($model, 'brandId')->dropDownList($model->brandsList(), ['prompt' => '-- Select brand --']) ?>
                </div>
                <div class="col-md-2">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-default">
                ...
                <div class="box-body">
                    <?= $form->field($model->categories, 'main')->dropDownList($model->categories->categoriesList(), ['prompt' => '-- Select category --']) ?>
        ...
        <div class="box-body">
            <?php foreach ($model->values as $i => $value): ?>
                <?php if ($variants = $value->variantsList()): ?>
                    <?= $form->field($value, '[' . $i . ']value')->dropDownList($variants, ['prompt' => '-- Select value --']) ?>
                <?php else: ?>
